  ...
  <div>
    ...
    <el-card style="margin:10px 0px">
      ...
      <div v-show="scene == 1">
        ...
        <el-button size="default" icon="Plus" @click="addAttrValue"
        ...
        <el-button type="primary" size="default" @click="save"
          :disabled="!attrParams.attrValueList[0]?.valueName">保存</el-button>
        <el-button type="primary" size="default" @click="cancel">取消</el-button>
      </div>
    </el-card>
  </div>
...
const save = async () => {
  //发请求
  let result: any = await addOrUpdataAttr(attrParams);
  //添加属性|修改已有的属性已经成功
  if (result.code == 200) {
    //切换场景
    scene.value = 0;
