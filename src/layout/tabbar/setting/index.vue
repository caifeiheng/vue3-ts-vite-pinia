<template>
  <el-button size="small" icon="Refresh" circle @click="onRefresh"></el-button>
  ...
  <el-popover placement="bottom" title="主题设置" :width="300" trigger="hover">
      ...
      <el-form>
          <el-form-item label="主题颜色">
              <el-color-picker size="small" show-alpha  v-model="color" @change="setColor"/>
          </el-form-item>
  ...
  <img :src="loginStore.avatar" style="width: 24px;height: 24px;margin:0px 10px;border-radius: 50%;">
  <!-- 下拉菜单 -->
  <el-dropdown>
